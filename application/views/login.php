...
<body>
                ...
                <?php } ?>
                          ...
                          <img src="<?php echo base_url()?>assets/img/logo.png"style="width: 60%;padding: 11px;margin-top: -30px;">
                          <br>
													    <div class="login">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
										...
										<div class="footer">
										   ...
										   <p>&copy 2020 Countryside Group . All Rights Reserved | Design by <a href="https://secondsdigital.com/" target="_blank">Seconds Digital Soultions</a></p>
										</div>
									<!--footer section end-->
									<!--/404-->
<!--js -->
